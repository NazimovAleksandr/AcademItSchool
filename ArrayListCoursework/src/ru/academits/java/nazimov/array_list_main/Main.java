...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayListMyImplementation<Integer> collection = new ArrayListMyImplementation<>();
        ...
        ArrayListMyImplementation<Integer> arrayList2 = new ArrayListMyImplementation<>(15);
